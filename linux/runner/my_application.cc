...
static void my_application_activate(GApplication* application) {
  ...
  // Set window icon for window managers, docks, and task switchers
  g_autofree gchar* exe_path = g_file_read_link("/proc/self/exe", nullptr);
  if (exe_path != nullptr) {
    g_autofree gchar* exe_dir = g_path_get_dirname(exe_path);
    g_autofree gchar* icon_path = g_build_filename(exe_dir, "data", "flutter_assets", "icon_design", "task_monitor_icon_1024x1024.png", nullptr);
